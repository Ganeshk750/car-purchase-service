...
public class PersonMapperImpl implements PersonMapper {
    ...
    public PersonDto toDto(Person person) {
        ...
        personDto.setAddresses( addressMapper.toDtoList( person.getAddresses() ) );
        personDto.setSoldCars( purchasedCarMapper.toDtoList( person.getSoldCars() ) );
        personDto.setPurchasedCars( purchasedCarMapper.toDtoList( person.getPurchasedCars() ) );
    ...
    protected List<Address> addressDtoListToAddressList(List<AddressDto> list) {
        ...
        for ( AddressDto addressDto : list ) {
            list1.add( addressMapper.toEntity( addressDto ) );
        }

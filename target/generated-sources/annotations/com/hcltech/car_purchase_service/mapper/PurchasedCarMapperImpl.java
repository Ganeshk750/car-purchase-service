...
public class PurchasedCarMapperImpl implements PurchasedCarMapper {
    ...
    @Override
    public List<PurchasedCarDto> toDtoList(List<PurchasedCar> PurchasedCar) {
        if ( PurchasedCar == null ) {
            return null;
        }

        List<PurchasedCarDto> list = new ArrayList<PurchasedCarDto>( PurchasedCar.size() );
        for ( PurchasedCar purchasedCar : PurchasedCar ) {
